...
| Chapter 6, Memory Must Earn Its Influence | How observations become candidate learning without silently becoming policy | `templates/continuous-improvement-experiment.md` | A useful lesson remains quarantined until separately admitted |
...
| Chapter 8, One Agent, Many Agents, and the Cost of Handoffs | When delegation repays its lineage, budget, cancellation, and integration costs | `templates/factory-architecture-decision-guide.md` | One integrating owner and conserved authority remain visible across every child |
